...
const errGlobal = `Installing Tealbase CLI as a global module is not supported.
Please use one of the supported package managers: https://github.com/tealbase/cli#install-the-cli
`;
...
async function main() {
  ...
  console.info("Installed Tealbase CLI successfully");
}
