...
import (
	...
	cli "github.com/tealbase/cli/cmd"
...
func generate(version string) error {
	...
	spec := SpecDoc{
		...
		Info: InfoDoc{
			...
			Description: forceMultiLine("Tealbase CLI provides you with tools to develop your application locally, and deploy your application to the Tealbase platform."),
			Language:    "sh",
			Source:      "https://github.com/tealbase/cli",
			Bugs:        "https://github.com/tealbase/cli/issues",
			Spec:        "https://github.com/tealbase/spec/cli_v1_commands.yaml",
			Tags:        getTags(root),
		},
	}
