...
import (
	...
	"github.com/tealbase/cli/internal/gen/types/typescript"
...
var (
	...
	genTypesTypescriptCmd = &cobra.Command{
		...
		Example: `  tealbase gen types typescript --local
  tealbase gen types typescript --linked
  tealbase gen types typescript --project-id abc-def-123 --schema public --schema private
  tealbase gen types typescript --db-url 'postgresql://...' --schema public --schema auth`,
	}
)
...
func init() {
	...
	keyFlags.StringVar(&flags.ProjectRef, "project-ref", "", "Project ref of the Tealbase project.")
