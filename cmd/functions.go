...
import (
	...
	"github.com/tealbase/cli/internal/functions/delete"
	"github.com/tealbase/cli/internal/functions/deploy"
	"github.com/tealbase/cli/internal/functions/download"
	"github.com/tealbase/cli/internal/functions/list"
	new_ "github.com/tealbase/cli/internal/functions/new"
...
var (
	functionsCmd = &cobra.Command{
		...
		Use:     "functions",
		Short:   "Manage Tealbase Edge functions",
	}

	functionsListCmd = &cobra.Command{
		Use:   "list",
		Short: "List all Functions in Tealbase",
		Long:  "List all Functions in the linked Tealbase project.",
	...
	functionsDeleteCmd = &cobra.Command{
		...
		Short: "Delete a Function from Tealbase",
		Long:  "Delete a Function from the linked Tealbase project. This does NOT remove the Function locally.",
	...
	functionsDownloadCmd = &cobra.Command{
		...
		Short: "Download a Function from Tealbase",
		Long:  "Download the source code for a Function from the linked Tealbase project.",
		Args:  cobra.ExactArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
	...
	functionsDeployCmd = &cobra.Command{
		...
		Short: "Deploy a Function to Tealbase",
		Long:  "Deploy a Function to the linked Tealbase project.",
		RunE: func(cmd *cobra.Command, args []string) error {
...
func init() {
	functionsListCmd.Flags().StringVar(&flags.ProjectRef, "project-ref", "", "Project ref of the Tealbase project.")
	functionsDeleteCmd.Flags().StringVar(&flags.ProjectRef, "project-ref", "", "Project ref of the Tealbase project.")
	functionsDeployCmd.Flags().BoolVar(noVerifyJWT, "no-verify-jwt", false, "Disable JWT verification for the Function.")
	functionsDeployCmd.Flags().StringVar(&flags.ProjectRef, "project-ref", "", "Project ref of the Tealbase project.")
	...
	functionsDownloadCmd.Flags().StringVar(&flags.ProjectRef, "project-ref", "", "Project ref of the Tealbase project.")
