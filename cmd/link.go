...
import (
	...
	"github.com/tealbase/cli/internal/link"
...
var (
	linkCmd = &cobra.Command{
		...
		Use:     "link",
		Short:   "Link to a Tealbase project",
...
func init() {
	...
	linkFlags.StringVar(&flags.ProjectRef, "project-ref", "", "Project ref of the Tealbase project.")
