...
import (
	...
	"github.com/tealbase/cli/internal/migration/squash"
	"github.com/tealbase/cli/internal/migration/up"
...
var (
	...
	migrationRepairCmd = &cobra.Command{
		...
		PostRun: func(cmd *cobra.Command, args []string) {
			fmt.Println("Finished " + utils.Aqua("tealbase migration repair") + ".")
		},
	}
	...
	migrationSquashCmd = &cobra.Command{
		...
		PostRun: func(cmd *cobra.Command, args []string) {
			fmt.Println("Finished " + utils.Aqua("tealbase migration squash") + ".")
		},
	}
