...
import (
	...
	"github.com/tealbase/cli/internal/ssl_enforcement/get"
	"github.com/tealbase/cli/internal/ssl_enforcement/update"
...
func init() {
	sslEnforcementCmd.PersistentFlags().StringVar(&flags.ProjectRef, "project-ref", "", "Project ref of the Tealbase project.")
