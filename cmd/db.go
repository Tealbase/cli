...
import (
	...
	"github.com/tealbase/cli/internal/db/branch/create"
	"github.com/tealbase/cli/internal/db/branch/delete"
	"github.com/tealbase/cli/internal/db/branch/list"
	"github.com/tealbase/cli/internal/db/branch/switch_"
	"github.com/tealbase/cli/internal/db/diff"
	"github.com/tealbase/cli/internal/db/dump"
	"github.com/tealbase/cli/internal/db/lint"
	"github.com/tealbase/cli/internal/db/pull"
	"github.com/tealbase/cli/internal/db/push"
	"github.com/tealbase/cli/internal/db/remote/changes"
	"github.com/tealbase/cli/internal/db/remote/commit"
	"github.com/tealbase/cli/internal/db/reset"
	"github.com/tealbase/cli/internal/db/start"
	"github.com/tealbase/cli/internal/db/test"
...
var (
	...
	dbPullCmd = &cobra.Command{
		...
		PostRun: func(cmd *cobra.Command, args []string) {
			fmt.Println("Finished " + utils.Aqua("tealbase db pull") + ".")
		},
	}
