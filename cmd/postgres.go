...
import (
	...
	"github.com/tealbase/cli/internal/postgresConfig/update"
...
func init() {
	postgresCmd.PersistentFlags().StringVar(&flags.ProjectRef, "project-ref", "", "Project ref of the Tealbase project.")
