...
import (
	...
	"github.com/tealbase/cli/internal/bans/get"
	"github.com/tealbase/cli/internal/bans/update"
...
func init() {
	bansCmd.PersistentFlags().StringVar(&flags.ProjectRef, "project-ref", "", "Project ref of the Tealbase project.")
