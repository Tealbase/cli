...
import (
	...
	"github.com/tealbase/cli/internal/hostnames/activate"
	"github.com/tealbase/cli/internal/hostnames/create"
	"github.com/tealbase/cli/internal/hostnames/delete"
	"github.com/tealbase/cli/internal/hostnames/get"
	"github.com/tealbase/cli/internal/hostnames/reverify"
...
var (
	customHostnamesCmd = &cobra.Command{
		...
		Use:     "domains",
		Short:   "Manage custom domain names for Tealbase projects",
		Long: `Manage custom domain names for Tealbase projects.
...
`,
	...
	customHostnamesCreateCmd = &cobra.Command{
		...
		Long: `Create a custom hostname for your Tealbase project.

Expects your custom hostname to have a CNAME record to your Tealbase project's subdomain.`,
	...
	customHostnamesGetCmd = &cobra.Command{
		...
		Long:  "Retrieve the custom hostname config for your project, as stored in the Tealbase platform.",
		RunE: func(cmd *cobra.Command, args []string) error {
...
This reconfigures your Tealbase project to respond to requests on your custom hostname.
After the custom hostname is activated, your project's auth services will no longer function on the Tealbase-provisioned subdomain.`,
		RunE: func(cmd *cobra.Command, args []string) error {
...
func init() {
	...
	customHostnamesCreateCmd.Flags().StringVar(&customHostname, "custom-hostname", "", "The custom hostname to use for your Tealbase project.")
