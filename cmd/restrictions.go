...
import (
	...
	"github.com/tealbase/cli/internal/restrictions/get"
	"github.com/tealbase/cli/internal/restrictions/update"
...
func init() {
	restrictionsCmd.PersistentFlags().StringVar(&flags.ProjectRef, "project-ref", "", "Project ref of the Tealbase project.")
