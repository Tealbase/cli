...
import (
	...
	"github.com/tealbase/cli/internal/vanity_subdomains/activate"
	"github.com/tealbase/cli/internal/vanity_subdomains/check"
	"github.com/tealbase/cli/internal/vanity_subdomains/delete"
	"github.com/tealbase/cli/internal/vanity_subdomains/get"
)
...
var (
	vanityCmd = &cobra.Command{
		...
		Short:   "Manage vanity subdomains for Tealbase projects",
		Long: `Manage vanity subdomains for Tealbase projects.
...
Usage of vanity subdomains and custom domains is mutually exclusive.`,
	...
	vanityActivateCmd = &cobra.Command{
		...
		Long: `Activate a vanity subdomain for your Tealbase project.

This reconfigures your Tealbase project to respond to requests on your vanity subdomain.
After the vanity subdomain is activated, your project's auth services will no longer function on the {project-ref}.{tealbase-domain} hostname.
`,
...
func init() {
	vanityCmd.PersistentFlags().StringVar(&flags.ProjectRef, "project-ref", "", "Project ref of the Tealbase project.")
	vanityActivateCmd.Flags().StringVar(&desiredSubdomain, "desired-subdomain", "", "The desired vanity subdomain to use for your Tealbase project.")
	vanityCheckCmd.Flags().StringVar(&desiredSubdomain, "desired-subdomain", "", "The desired vanity subdomain to use for your Tealbase project.")
