...
import (
	...
	"github.com/tealbase/cli/internal/projects/apiKeys"
	"github.com/tealbase/cli/internal/projects/create"
	"github.com/tealbase/cli/internal/projects/delete"
	"github.com/tealbase/cli/internal/projects/list"
...
var (
	projectsCmd = &cobra.Command{
		...
		Use:     "projects",
		Short:   "Manage Tealbase projects",
	}
	...
	projectsCreateCmd = &cobra.Command{
		...
		Short:   "Create a project on Tealbase",
		Args:    cobra.MaximumNArgs(1),
		Example: `tealbase projects create my-project --org-id cool-green-pqdr0qc --db-password ******** --region us-east-1`,
	...
	projectsListCmd = &cobra.Command{
		Use:   "list",
		Short: "List all Tealbase projects",
		Long:  "List all Tealbase projects the logged-in user can access.",
		RunE: func(cmd *cobra.Command, args []string) error {
	...
	projectsApiKeysCmd = &cobra.Command{
		Use:   "api-keys",
		Short: "List all API keys for a Tealbase project",
		RunE: func(cmd *cobra.Command, args []string) error {
	...
	projectsDeleteCmd = &cobra.Command{
		Use:   "delete <ref>",
		Short: "Delete a Tealbase project",
		Args:  cobra.MaximumNArgs(1),
		PreRunE: func(cmd *cobra.Command, args []string) error {
...
func init() {
	...
	apiKeysFlags.StringVar(&flags.ProjectRef, "project-ref", "", "Project ref of the Tealbase project.")
