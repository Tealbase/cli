...
import (
	...
	"github.com/tealbase/cli/internal/secrets/list"
	"github.com/tealbase/cli/internal/secrets/set"
	"github.com/tealbase/cli/internal/secrets/unset"
...
var (
	secretsCmd = &cobra.Command{
		...
		Use:     "secrets",
		Short:   "Manage Tealbase secrets",
	}

	secretsListCmd = &cobra.Command{
		Use:   "list",
		Short: "List all secrets on Tealbase",
	...
	secretsSetCmd = &cobra.Command{
		...
		Short: "Set a secret(s) on Tealbase",
		Long:  "Set a secret(s) to the linked Tealbase project.",
		RunE: func(cmd *cobra.Command, args []string) error {
	...
	secretsUnsetCmd = &cobra.Command{
		Use:   "unset <NAME> ...",
		Short: "Unset a secret(s) on Tealbase",
		Long:  "Unset a secret(s) from the linked Tealbase project.",
		RunE: func(cmd *cobra.Command, args []string) error {
...
func init() {
	secretsCmd.PersistentFlags().StringVar(&flags.ProjectRef, "project-ref", "", "Project ref of the Tealbase project.")
