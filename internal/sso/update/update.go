...
import (
	...
	"github.com/tealbase/cli/internal/sso/internal/render"
	"github.com/tealbase/cli/internal/sso/internal/saml"
...
func Run(ctx context.Context, params RunParams) error {
	getResp, err := utils.GetTealbase().GetProviderByIdWithResponse(ctx, params.ProjectRef, params.ProviderID)
	if err != nil {
	...
	putResp, err := utils.GetTealbase().UpdateProviderByIdWithResponse(ctx, params.ProjectRef, params.ProviderID, body)
	if err != nil {
